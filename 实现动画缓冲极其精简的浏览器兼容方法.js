...
(function () {
    ...
    function listToArray(likeArray) {
        ...
        var cur=lazyFn(arr,likeArray);
        listToArray=cur;
        return cur(likeArray);
    ...
    function getElementsByClass(classStr, context) {
        ...
        if(cur) {
            getElementsByClass = cur;
            return getElementsByClass(classStr, context);
        }
    ...
    function setGroupCss(ele, opations) {
        ...
        if (opations.toString() == '[object Object]') {
            for (var key in opations) {
                if(opations.hasOwnProperty(key))setCss(ele, key, opations[key]);
            }
        }
